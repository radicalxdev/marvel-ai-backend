...
from features.syllabus_generator.tools import SyllabusBuilder,SyllabusModel,read_text_file
...
class TestToolMethods(unittest.TestCase):
    ...
    def test_create_custom_promptTemp(self, mock_dirname, mock_join, mock_open):
        sb = SyllabusBuilder(grade_level="grade 4", subject="Math", customisation="Focus on Geometry")
    ...
    def test_validate_response_valid(self):
        ...
        valid_response = {
            ...
            "additional_information": {
                ...
                "Resources": ["Textbook: Electrocardiography for Healthcare Professionals", ...]
            }
        }
    ...
    def test_compile_customisation_and_syllabus(self, mock_json_parser, mock_google_model, mock_prompt_template,mock_create_prompt_temp, mock_create_custom_promptTemp):
