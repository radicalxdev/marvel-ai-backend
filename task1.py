...
class DocumentProcessor:
    ...
    def process_file(self, uploaded_file):
        ...
        #elif file_extension in [".docx", ".doc", ".pptx", ".ppt"]: # original
        elif file_extension in [".pptx", ".ppt"]: # new
            #loader = PyMuPDFLoader(temp_file_path) # original
            loader = UnstructuredPowerPointLoader(temp_file_path) # new
